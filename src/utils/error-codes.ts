...
export const ErrorMessages: Record<ErrorCode, string> = {
  ...
  [ErrorCodes.AUTH_DISABLED_KEY]:
    "API key is disabled. Contact support to re-enable your key.",
  ...
  [ErrorCodes.CONCURRENT_LIMIT_EXCEEDED]:
    "Concurrent task limit exceeded. Wait for running tasks to complete.",

  // Task
  [ErrorCodes.TASK_NOT_FOUND]:
    "Task not found. The task may have expired or been deleted.",
  [ErrorCodes.TASK_NOT_CANCELLABLE]:
    "Task cannot be cancelled. Only pending or running tasks can be cancelled.",
  [ErrorCodes.TASK_TIMEOUT]:
    "Task timed out. The operation exceeded the maximum allowed duration.",
  [ErrorCodes.TASK_EXECUTION_FAILED]:
    "Task execution failed. Check the error details for more information.",
  [ErrorCodes.TASK_CLONE_FAILED]:
    "Failed to clone repository. Verify the URL and credentials.",

  // Artifacts
  [ErrorCodes.LOGS_NOT_FOUND]:
    "Logs not found. The task may still be running or logs may have expired.",
  [ErrorCodes.DIFF_NOT_FOUND]:
    "Diff not found. The task may not have made any changes.",

  // Push
  [ErrorCodes.PUSH_NOT_COMPLETED]:
    "Cannot push changes. The task has not completed successfully.",
  [ErrorCodes.PUSH_NO_CREDENTIALS]:
    "Cannot push changes. No git credentials were provided.",
  [ErrorCodes.PUSH_FAILED]: "Failed to push changes to remote repository.",

  // Stream
  [ErrorCodes.STREAM_UPGRADE_REQUIRED]:
    "WebSocket upgrade required. Use a WebSocket client to connect.",
  ...
  [ErrorCodes.STREAM_TASK_RUNNING]:
    "Task is already running. Cannot start a new execution.",
