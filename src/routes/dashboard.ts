    ...
    <body>
      ...
      <script>
        ...
        async function loadTasks() {
          // Note: The API doesn't have a list endpoint, so we show stored task IDs
          // In a real implementation, you'd need a list endpoint
        ...
        async function loadUsage() {
          ...
          try {
            ...
            document.getElementById("totalRequests").textContent =
              formatNumber(data.totals?.requests || 0);
            ...
            document.getElementById("estimatedCost").textContent =
              "$" + (data.totals?.estimatedCost || 0).toFixed(4);
...
// Dashboard route - serves the HTML
